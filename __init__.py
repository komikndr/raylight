...
from raylight.expansion.karmabu_adapters import NODE_CLASS_MAPPINGS as KARMABU_ADAPTER_CLASS_MAPPINGS
from raylight.expansion.karmabu_adapters import NODE_DISPLAY_NAME_MAPPINGS as KARMABU_ADAPTER_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS.update(KARMABU_ADAPTER_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(KARMABU_ADAPTER_DISPLAY_NAME_MAPPINGS)
